{ stdenv, fetchurl }:
  ...
  in {
    ...
    pipeline-model-api = mkJenkinsPlugin {
      ...
      src = fetchurl {
        url = "https://updates.jenkins-ci.org/download/plugins/pipeline-model-api/2.2218.v56d0cda_37c72/pipeline-model-api.hpi";
        sha256 = "05a28969c6a37e08cd7fc14ccfeb074c85c339527305d032d8fc067b51540215";
        };
      };
    pipeline-model-definition = mkJenkinsPlugin {
      name = "pipeline-model-definition";
      src = fetchurl {
        url = "https://updates.jenkins-ci.org/download/plugins/pipeline-model-definition/2.2218.v56d0cda_37c72/pipeline-model-definition.hpi";
        sha256 = "3215bc79872c7d3275810bccbe98117632fb83f1de47ace9ab7fe7dd4b44e9c4";
        };
      };
    pipeline-model-extensions = mkJenkinsPlugin {
      name = "pipeline-model-extensions";
      src = fetchurl {
        url = "https://updates.jenkins-ci.org/download/plugins/pipeline-model-extensions/2.2218.v56d0cda_37c72/pipeline-model-extensions.hpi";
        sha256 = "aaed7da80f6e4d1d3aa5b8b68fcae52706f1ceb3ef5defb0e88f644076be247c";
        };
      };
    ...
    pipeline-stage-tags-metadata = mkJenkinsPlugin {
      ...
      src = fetchurl {
        url = "https://updates.jenkins-ci.org/download/plugins/pipeline-stage-tags-metadata/2.2218.v56d0cda_37c72/pipeline-stage-tags-metadata.hpi";
        sha256 = "e009f82cd40ee5c00fce925131d368b2ff3dae192982db1e56a405aea0ec5dbb";
        };
      };
    ...
    slack = mkJenkinsPlugin {
      name = "slack";
      src = fetchurl {
        url = "https://updates.jenkins-ci.org/download/plugins/slack/760.vb_e6a_66db_2d43/slack.hpi";
        sha256 = "98fc0fb1cb0caf19e351de1ab10f8fbe8354020aba77534e22a8704d6c02f035";
        };
      };
